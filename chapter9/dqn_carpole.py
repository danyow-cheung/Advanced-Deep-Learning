...
class DQNAgent:
    ...
    def replay(self,batch_size):
        '''
        experience replay address the correlation issue between samples
        Arguments:
        ...
        for state,action,reward ,next_state ,done in sars_batch:
            ...
            # correction on the q valu for the action used 
            q_values[0][action] = reward if done else q_value
            # collect batch state-q_valu mapping 
        ...
        # update exploration-exploitation probabiliyu
        self.update_epsilon()
...
class DDQNAgent(DQNAgent):
    ...
    def get_target_q_value(self, next_state, reward):
        ...
        '''
        Compute Q_max use of target Q network solves the non-stationarity problem
        Arguments:
